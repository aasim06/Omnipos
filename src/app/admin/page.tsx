        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-1 bg-[#161822] p-1 rounded-md border border-[#232734]">
              {/* <button
                type="button"
                onClick={() => setActiveModule("fastfood")}
              ...
              >
                <UtensilsCrossed size={14} /> Fast Food
              </button> */}
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-md text-white text-xs font-bold transition flex items-center gap-1 shadow-md ${
                activeModule === "fastfood" ? "bg-[#ff6b00] hover:bg-[#e05e00]" : "bg-[#00c9a7] text-[#00201a] hover:bg-[#00b093]"
              }`}
            >
