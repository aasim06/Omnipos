...
export const useProductsCatalogStyles = makeStyles({
  ...
  categoryPillFood: {
    ...
    borderTopWidth: '1px', borderBottomWidth: '1px', borderLeftWidth: '1px', borderRightWidth: '1px',
    borderTopStyle: 'solid', borderBottomStyle: 'solid', borderLeftStyle: 'solid', borderRightStyle: 'solid',
    borderTopColor: '#FFEDD5', borderBottomColor: '#FFEDD5', borderLeftColor: '#FFEDD5', borderRightColor: '#FFEDD5',
    padding: '3px 10px',
    borderRadius: '9999px',
    fontWeight: 600,
    fontSize: '11.5px',
  ...
  categoryPillRetail: {
    ...
    borderTopWidth: '1px', borderBottomWidth: '1px', borderLeftWidth: '1px', borderRightWidth: '1px',
    borderTopStyle: 'solid', borderBottomStyle: 'solid', borderLeftStyle: 'solid', borderRightStyle: 'solid',
    borderTopColor: '#DBEAFE', borderBottomColor: '#DBEAFE', borderLeftColor: '#DBEAFE', borderRightColor: '#DBEAFE',
    padding: '3px 10px',
    borderRadius: '9999px',
    fontWeight: 600,
    fontSize: '11.5px',
  ...
  statusAvailable: {
    ...
    borderTopWidth: '1px', borderBottomWidth: '1px', borderLeftWidth: '1px', borderRightWidth: '1px',
    borderTopStyle: 'solid', borderBottomStyle: 'solid', borderLeftStyle: 'solid', borderRightStyle: 'solid',
    borderTopColor: '#A7F3D0', borderBottomColor: '#A7F3D0', borderLeftColor: '#A7F3D0', borderRightColor: '#A7F3D0',
    width: 'fit-content',
  },
  statusUnavailable: {
    display: 'inline-flex',
